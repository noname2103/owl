...
<!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Sửa bình luận
                        </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                    <div class="col-lg-7" style="padding-bottom:120px">
                        <form action="{{route('addcomment')}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select name="mathanhvien">
                                    ...
                                    @foreach($member as $row)
                                        @if($row->mathanhvien == $comment->mathanhvien)
                            ...
                            <div class="form-group">
                                ...
                                <textarea placeholder="Nhập nội dung" rows="10" cols="140" style="resize: none;" name="noidung">{{$comment->noidung}}</textarea>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="mastatus">
                                    ...
                                    @foreach($status as $row)
                                         @if($row->mastatus == $comment->mastatus)
                                            <option value="{{$row->mastatus}}" selected="selected">{{$row->mastatus}}</option>
                                        @else
